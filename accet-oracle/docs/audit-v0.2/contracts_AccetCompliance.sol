...
/*
  ...
  - AccetSBT: minimal non-transferable ERC721-like token that references metadata (tokenURI)
  NOTE: This is a test scaffold. Do not use as-is in production without security/audit.
*/
...
contract AccetSBT is ERC721, Ownable {
    ...
    // Only mint if recipient is compliant (registry.isVerified)
    ...
    // Non-transferable: block transfers except minting (from==0) and burning by owner
