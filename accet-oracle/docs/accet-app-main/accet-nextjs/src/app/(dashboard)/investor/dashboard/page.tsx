...
<h2 className="text-4xl font-finance font-bold text-white mb-2">$48.5M <span className="text-lg font-display text-slate-400">COP</span></h2>
<div className="flex items-center gap-2 text-primary">
<span className="material-symbols-outlined text-sm">trending_up</span>
<span className="text-sm font-bold">+5.4% <span className="text-slate-500 font-normal ml-1">vs last month</span></span>
</div>
</div>
<div className="glass-panel rounded-2xl p-6 relative overflow-visible">
...
<h3 className="text-lg font-bold text-white">Portfolio Breakdown</h3>
...
<span className="text-xs font-bold uppercase tracking-wider">Upcoming Distribution</span>
</div>
<h3 className="text-3xl font-finance font-bold text-white mb-2">$1.84M <span className="text-sm font-display text-slate-400">COP</span></h3>
...
<span className="font-finance text-white text-lg">4,250.22 HBAR</span>
</div>
...
<span className="text-xs font-finance text-primary">58%</span>
</div>
<div className="h-1.5 w-full bg-slate-800 rounded-full overflow-visible">
<div className="h-full bg-primary neon-emerald" style={{ width: "58%" }}></div>
</div>
</div>
{/*  City 2  */}
<div className="flex flex-col gap-2">
...
<span className="text-xs font-finance text-accent-blue">32%</span>
</div>
<div className="h-1.5 w-full bg-slate-800 rounded-full overflow-visible">
<div className="h-full bg-accent-blue neon-sky" style={{ width: "32%" }}></div>
</div>
</div>
{/*  City 3  */}
<div className="flex flex-col gap-2">
<div className="flex justify-between items-center">
<span className="text-sm font-medium text-white">Barranquilla</span>
<span className="text-xs font-finance text-slate-400">10%</span>
</div>
<div className="h-1.5 w-full bg-slate-800 rounded-full overflow-visible">
<div className="h-full bg-slate-600" style={{ width: "10%" }}></div>
</div>
</div>
</div>
...
<div className="absolute top-1/2 left-1/3 size-3 bg-primary rounded-full neon-emerald border-2 border-white/20 animate-pulse"></div>
