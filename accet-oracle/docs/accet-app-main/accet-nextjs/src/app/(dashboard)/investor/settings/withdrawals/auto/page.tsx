...
{/*  Crypto Wallet  */}
<label className="relative flex cursor-pointer group">
<input className="sr-only peer" name="destination" type="radio"/>
<div className="w-full p-4 rounded-lg border-2 border-white/5 bg-white/5 peer-checked:border-primary peer-checked:bg-primary/5 transition-all">
<div className="flex justify-between items-start mb-3">
...
<p className="text-xs text-slate-400">Processing via PSE Network + Network Gas</p>
</div>
</div>
<div className="flex flex-col md:items-end">
<p className="text-lg font-bold text-white">$2,500 COP <span className="text-xs text-slate-500 font-normal">est. fee</span></p>
<p className="text-xs text-accent-cyan">Est. arrival: 24-48h</p>
</div>
</div>
</div>
{/*  Action Footer  */}
<div className="flex flex-col md:flex-row items-center justify-end gap-4 mt-4">
<button className="w-full md:w-auto px-8 py-3 rounded-lg text-slate-300 hover:text-white font-bold transition-colors">
                            Discard Changes
                        </button>
<button className="w-full md:w-auto px-10 py-3 rounded-lg bg-primary text-black font-extrabold hover:brightness-110 transition-all shadow-lg neon-glow">
                            Save Configuration
                        </button>
</div>
</div>
