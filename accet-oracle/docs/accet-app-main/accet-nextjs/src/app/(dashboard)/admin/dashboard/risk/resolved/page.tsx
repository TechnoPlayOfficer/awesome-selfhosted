...
<h3 className="font-financial text-3xl font-bold tracking-tight text-white">99.2<span className="text-accent-teal">%</span></h3>
<div className="mt-4 w-full bg-white/5 h-1.5 rounded-full overflow-visible">
<div className="bg-accent-teal h-full rounded-full" style={{ width: "99.2%" }}></div>
</div>
</div>
<div className="glass-panel rounded-xl p-6 relative overflow-visible border-accent-teal/20" style={{ boxShadow: "0 0 20px rgba(45, 212, 191, 0.1)" }}>
<p className="text-slate-500 text-xs font-semibold mb-1 uppercase tracking-wider">LTV Risk Alerts</p>
<h3 className="font-financial text-3xl font-bold tracking-tight text-accent-teal">00 <span className="text-slate-500 text-lg font-display">All Clear</span></h3>
<div className="mt-4 flex items-center gap-2 text-accent-teal text-xs font-bold">
...
<td className="py-4 px-2">
<span className="px-2 py-1 rounded bg-primary/10 text-primary text-[10px] font-bold border border-primary/20 uppercase">Stable</span>
</td>
<td className="py-4 px-2">
<div className="flex items-center gap-2">
<div className="w-24 h-1 bg-white/5 rounded-full">
...
<span className="text-xs font-bold text-primary">58% LTV</span>
</div>
</td>
...
<span className="px-2 py-0.5 bg-amber-500/10 text-amber-500 text-[10px] font-bold border border-amber-500/20 rounded">MODERATE VOLATILITY</span>
</div>
</div>
</div>
{/*  Compliance & Audit  */}
...
<circle className="text-primary" cx="80" cy="80" fill="transparent" r="70" stroke="currentColor" stroke-dasharray="440" stroke-dashoffset="14" strokeWidth="8"></circle>
</svg>
...
<span className="text-white font-bold">99.8% Pass</span>
</div>
<div className="flex items-center justify-between text-xs">
<span className="text-slate-400 flex items-center gap-2">
