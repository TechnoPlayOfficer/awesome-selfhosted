...
<span className="text-xs font-mono uppercase tracking-widest">Minting in Progress</span>
</div>
...
<button className="px-6 py-2.5 rounded-lg border border-red-900/50 bg-red-950/20 text-red-400 font-bold text-sm hover:bg-red-950/40 transition-colors">Abort Process</button>
<button className="px-6 py-2.5 rounded-lg bg-primary text-background-dark font-bold text-sm hover:opacity-90 transition-opacity flex items-center gap-2 shadow-[0_0_25px_rgba(30,210,120,0.5)] animate-pulse">
...
<div className="flex items-center gap-2">
<div className="size-2 bg-primary rounded-full animate-pulse shadow-[0_0_8px_#1ed278]"></div>
<span className="text-[10px] font-mono text-primary font-bold">MINTING IN PROGRESS</span>
</div>
</div>
...
<p className="text-primary animate-pulse"><span className="text-primary mr-2">[14:32:08]</span> Awaiting final authorization from multi-sig...</p>
<div className="h-2 w-full bg-slate-900 rounded-full mt-4">
<div className="h-full bg-primary w-[85%] rounded-full relative transition-all duration-1000">
...
<span className="animate-pulse text-slate-400">Distribution</span>
</div>
</div>
</section>
</div>
