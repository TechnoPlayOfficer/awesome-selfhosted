...
{/*  Dashboard Body  */}
<div className="flex-1 overflow-y-auto p-8 custom-scrollbar"><div className="mb-6 p-4 bg-rose-500/10 border border-rose-500/50 rounded-xl flex items-center justify-between animate-pulse shadow-[0_0_15px_rgba(244,63,94,0.2)]">
<div className="flex items-center gap-3">
<span className="material-symbols-outlined text-rose-500">error</span>
<div>
<p className="text-rose-500 font-bold text-sm uppercase tracking-wider">Critical Risk Mitigation Required</p>
<p className="text-slate-400 text-xs">3 Active LTV Breaches detected on Hedera Mainnet. Immediate action recommended.</p>
</div>
</div>
<button className="px-4 py-2 bg-rose-500 text-white text-xs font-bold rounded-lg hover:bg-rose-600 transition-colors uppercase tracking-tighter shadow-lg shadow-rose-500/20">Resolve All</button>
</div>
{/*  KPIs Section  */}
...
<div className="glass-panel rounded-xl p-6 relative overflow-visible" style={{ boxShadow: "0 0 20px rgba(244, 63, 94, 0.3)" }}>
<p className="text-slate-500 text-xs font-semibold mb-1 uppercase tracking-wider">LTV Risk Alerts</p>
<h3 className="font-financial text-3xl font-bold tracking-tight text-rose-500 animate-pulse">03 <span className="text-slate-500 text-lg">Critical</span></h3>
...
<td className="py-4 px-2">
<div className="flex items-center gap-3">
<div className="w-8 h-8 rounded bg-rose-900/20 border border-rose-500/30 flex items-center justify-center">
<span className="material-symbols-outlined text-rose-500 text-sm">domain</span>
</div>
<span className="font-medium text-slate-200">Torre Empresarial Chicó</span>
</div>
</td>
<td className="py-4 px-2">
<span className="px-2 py-1 rounded bg-rose-500/20 text-rose-500 text-[10px] font-bold border border-rose-500/30 uppercase">LTV BREACH</span>
</td>
<td className="py-4 px-2">
<div className="flex items-center gap-2">
<div className="w-24 h-1 bg-white/5 rounded-full">
<div className="bg-rose-500 h-full rounded-full" style={{ width: "72%" }}></div>
</div>
<span className="text-xs font-bold text-rose-500">72% LTV</span>
</div>
</td>
<td className="py-4 px-2 font-financial text-slate-300">$1.2B</td>
<td className="py-4 px-2 text-right">
<button className="material-symbols-outlined text-rose-500 hover:text-white">warning</button>
</td>
</tr>
</tbody>
</table>
...
<span className="px-2 py-0.5 bg-amber-500/10 text-amber-500 text-[10px] font-bold border border-amber-500/20 rounded animate-pulse">HIGH VOLATILITY</span>
</div>
</div>
</div>
{/*  Compliance & Audit  */}
...
<circle className="text-amber-500" cx="80" cy="80" fill="transparent" r="70" stroke="currentColor" stroke-dasharray="440" stroke-dashoffset="90" strokeWidth="8"></circle>
</svg>
<div className="absolute inset-0 flex flex-col items-center justify-center">
<span className="text-3xl font-financial font-bold text-white">88.4</span>
